...
# our_intersection = my_schedule.intersection(majestik_schedule)#method syntax
...
# common_pets = reynelles_pets | julie_samuels_pets | kat_pollans_pets | majestic_pets #operator sytax
...
# both_criteria = over_60_years & over_5_purchases 
# print(both_criteria)
...
dev_type_input, dev_name_input = (), set()
